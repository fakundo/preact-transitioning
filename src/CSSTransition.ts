...
const computeClassName = (phase: Phase, classNames: CSSTransitionClassNames) => {
  ...
  switch (phase) {
    case Phase.APPEAR_ACTIVE: return joinClassNames(recoverClassName(Phase.APPEAR, classNames), className)
    case Phase.ENTER_ACTIVE: return joinClassNames(recoverClassName(Phase.ENTER, classNames), className)
    case Phase.EXIT_ACTIVE: return joinClassNames(recoverClassName(Phase.EXIT, classNames), className)
